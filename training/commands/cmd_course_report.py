...
@click.option(
    ...
    "--get_csv",
    is_flag=True,
    help="Flag that, when enabled, downloads course completion csv files.",
)
@click.option(
    "-e",
    "--export_combined",
    is_flag=True,
    help="Flag that, when enabled, exports a combined csv for each month. Can be used for email status updates.",
)
