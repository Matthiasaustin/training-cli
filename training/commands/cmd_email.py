...
@click.command()
@click.option(
    "-f", "--file_name", type=str, help="The file to be used for staff name and emails."
)
@click.option(
    "-m",
    "--message_type",
    type=str,
    help="Type of message to be sent (i.e. CPR Start off email, Forty Hour reminder email, etc.)",
)
